...
# === IDs das planilhas ===
planilhas_ids = {
        "Financeiro_contas_a_receber_GED": "1T4IDEDVLvOP1YfRnq_Fp-FKk4x6-dQhCZ3rAHDdZ300",
    "Financeiro_contas_a_pagar_GED": "1aCnWvM6T1kGslwDM_HXTpD26B_ywT5WQxdLiluLfv0E",
    "Financeiro_Completo_GED": "1EjCEgVLn5spxEnPngzUigdCKhIVcn_1SnP0V6IBJNGo"
}
...
print("\n📋 Limpando: Financeiro_contas_a_receber_GED")
planilha_receber = client.open_by_key(planilhas_ids["Financeiro_contas_a_receber_GED"])
aba_receber = planilha_receber.sheet1
limpar_aba_completa(aba_receber, "Contas a Receber")

# 2. Limpa TUDO de Contas a Pagar
print("\n📋 Limpando: Financeiro_contas_a_pagar_GED")
planilha_pagar = client.open_by_key(planilhas_ids["Financeiro_contas_a_pagar_GED"])
...
print("\n📋 Limpando: Financeiro_Completo_GED (sheet1)")
planilha_completo = client.open_by_key(planilhas_ids["Financeiro_Completo_GED"])
...
print("\n📋 Limpando: Financeiro_Completo_GED (Dados_Pivotados)")
try:
