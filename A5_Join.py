...
df_receber = ler_planilha_por_id("Financeiro_contas_a_receber_GED")
df_pagar = ler_planilha_por_id("Financeiro_contas_a_pagar_GED")
...
planilha_saida = client.open_by_key(planilhas_ids["Financeiro_Completo_GED"])
